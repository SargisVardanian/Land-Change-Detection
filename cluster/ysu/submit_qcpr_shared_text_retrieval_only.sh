...
J4=$(sbatch --parsable --dependency=afterok:$J3 --job-name=qcpr-text-report --cpus-per-task=2 --mem=8G --time=01:00:00 --wrap="$common; /mnt/weka/svardanyan/rs_change_project/envs/rschange/bin/python scripts/build_qcpr_emergent_report.py --chain-root $RUN")
