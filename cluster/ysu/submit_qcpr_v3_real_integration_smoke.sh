...
mkdir -p "$RUN_ROOT"
export EXPECTED_SHA RUN_ROOT CONFIG_PATH DATA_RELEASE CHECKPOINT_PATH CHECKPOINT_SHA256
export WORKTREE PROJECT_ROOT PYTHON TRAIN_MANIFEST DEVELOPMENT_MANIFEST
export UNISAT_SOURCE UNISAT_CHECKPOINT JINA_MODEL
export STEPS PHYSICAL_BATCH_SIZE CAPTIONS_PER_PAIR
