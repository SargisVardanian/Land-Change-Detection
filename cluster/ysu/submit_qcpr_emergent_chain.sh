...
QCPR_WORKTREE=${QCPR_WORKTREE:-$ROOT/code/project-qcpr-emergent-grounding-long}
...
test ! -e "$CHAIN_ROOT"
mkdir -p "$CHAIN_ROOT"
export QCPR_WORKTREE EXPECTED_SHA CHAIN_ROOT MANIFEST_DIR S2LOOKING_MANIFEST_DIR
