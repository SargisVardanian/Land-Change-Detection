...
def main() -> int:
    ...
    structured_ready=structured.get("status")=="STRUCTURED_SOURCE_SEMANTIC_READY" and bool(structured.get("training_enabled")) and bool(structured_loader.get("passed"))
