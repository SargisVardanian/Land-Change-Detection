...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Inspect the local Prithvi/TerraTorch runtime contract.")
...
def main() -> int:
    ...
    args.output.write_text(json.dumps(resolution.to_dict(), indent=2), encoding="utf-8")
