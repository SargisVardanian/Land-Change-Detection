...
Последняя зафиксированная голова ветки в этом versioned snapshot: `6223d172307fce4a09b739ebc5442d822e437534` (live local/remote/PR SHA нужно читать из Git, чтобы snapshot не был самоссылочным).
