...
def _write_handoff(root: Path, *, forbidden: bool = False) -> Path:
    ...
    handoff = {
        ...
        "benchmark_contract": {"name": "QCPR_BITEMPORAL_CORE_BENCHMARK_V1"},
        "relevance_contract": {"exact": "grade3_positive"},
        "sampler_contract": {"deterministic": True},
        "caption_rotation_contract": {"captions_per_pair": 2},
